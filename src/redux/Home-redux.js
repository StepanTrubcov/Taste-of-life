...
const initialState = [
    {
        ...
        text:'Откройте для себя разнообразие вкусных и полезных рецептов, которые подходят для любого повода! Найдите вдохновение для завтраков, обедов, ужинов и десертов. Легкие в приготовлении и с использованием доступных ингредиентов!'
    },
    {
        id:2,
